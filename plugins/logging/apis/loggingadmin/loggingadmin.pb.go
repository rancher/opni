...
var file_github_com_rancher_opni_plugins_logging_apis_loggingadmin_loggingadmin_proto_rawDesc = []byte{
	...
	0x65, 0x32, 0xe2, 0x09, 0x0a, 0x0e, 0x4c, 0x6f, 0x67, 0x67, 0x69, 0x6e, 0x67, 0x41, 0x64, 0x6d,
	...
	0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x42, 0x3b, 0x5a, 0x39, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x72, 0x61, 0x6e, 0x63, 0x68, 0x65, 0x72, 0x2f, 0x6f, 0x70, 0x6e,
	0x69, 0x2f, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x73, 0x2f, 0x6c, 0x6f, 0x67, 0x67, 0x69, 0x6e,
...
var file_github_com_rancher_opni_plugins_logging_apis_loggingadmin_loggingadmin_proto_msgTypes = make([]protoimpl.MessageInfo, 28)
var file_github_com_rancher_opni_plugins_logging_apis_loggingadmin_loggingadmin_proto_goTypes = []interface{}{
	...
	nil,                               // 23: loggingadmin.OpensearchNodeDetails.NodeSelectorEntry
	nil,                               // 24: loggingadmin.DataDetails.NodeSelectorEntry
	nil,                               // 25: loggingadmin.IngestDetails.NodeSelectorEntry
	nil,                               // 26: loggingadmin.ControlplaneDetails.NodeSelectorEntry
	nil,                               // 27: loggingadmin.MlDetails.NodeSelectorEntry
	(*v1.Toleration)(nil),             // 28: k8s.io.api.core.v1.Toleration
...
var file_github_com_rancher_opni_plugins_logging_apis_loggingadmin_loggingadmin_proto_depIdxs = []int32{
	...
	22, // 5: loggingadmin.OpensearchClusterV2.mlNodes:type_name -> loggingadmin.MlDetails
	...
	23, // 9: loggingadmin.OpensearchNodeDetails.NodeSelector:type_name -> loggingadmin.OpensearchNodeDetails.NodeSelectorEntry
	28, // 10: loggingadmin.OpensearchNodeDetails.Tolerations:type_name -> k8s.io.api.core.v1.Toleration
	1,  // 11: loggingadmin.OpensearchNodeDetails.Persistence:type_name -> loggingadmin.DataPersistence
	11, // 12: loggingadmin.DashboardsDetails.resources:type_name -> loggingadmin.ResourceRequirements
	12, // 13: loggingadmin.ResourceRequirements.requests:type_name -> loggingadmin.ComputeResourceQuantities
	12, // 14: loggingadmin.ResourceRequirements.limits:type_name -> loggingadmin.ComputeResourceQuantities
	2,  // 15: loggingadmin.DataDetails.cpuResources:type_name -> loggingadmin.CPUResource
	24, // 16: loggingadmin.DataDetails.nodeSelector:type_name -> loggingadmin.DataDetails.NodeSelectorEntry
	28, // 17: loggingadmin.DataDetails.tolerations:type_name -> k8s.io.api.core.v1.Toleration
	...
	25, // 20: loggingadmin.IngestDetails.nodeSelector:type_name -> loggingadmin.IngestDetails.NodeSelectorEntry
	28, // 21: loggingadmin.IngestDetails.tolerations:type_name -> k8s.io.api.core.v1.Toleration
	26, // 22: loggingadmin.ControlplaneDetails.nodeSelector:type_name -> loggingadmin.ControlplaneDetails.NodeSelectorEntry
	28, // 23: loggingadmin.ControlplaneDetails.tolerations:type_name -> k8s.io.api.core.v1.Toleration
	1,  // 24: loggingadmin.ControlplaneDetails.persistence:type_name -> loggingadmin.DataPersistence
	18, // 25: loggingadmin.SnapshotSchedule.ref:type_name -> loggingadmin.SnapshotReference
	19, // 26: loggingadmin.SnapshotSchedule.retention:type_name -> loggingadmin.SnapshotRetention
	21, // 27: loggingadmin.SnapshotStatusList.statuses:type_name -> loggingadmin.SnapshotStatus
	18, // 28: loggingadmin.SnapshotStatus.ref:type_name -> loggingadmin.SnapshotReference
	29, // 29: loggingadmin.SnapshotStatus.lastUpdated:type_name -> google.protobuf.Timestamp
	2,  // 30: loggingadmin.MlDetails.cpuResources:type_name -> loggingadmin.CPUResource
	27, // 31: loggingadmin.MlDetails.nodeSelector:type_name -> loggingadmin.MlDetails.NodeSelectorEntry
	28, // 32: loggingadmin.MlDetails.tolerations:type_name -> k8s.io.api.core.v1.Toleration
	1,  // 33: loggingadmin.MlDetails.persistence:type_name -> loggingadmin.DataPersistence
	30, // 34: loggingadmin.LoggingAdminV2.GetOpensearchCluster:input_type -> google.protobuf.Empty
	30, // 35: loggingadmin.LoggingAdminV2.DeleteOpensearchCluster:input_type -> google.protobuf.Empty
	0,  // 36: loggingadmin.LoggingAdminV2.CreateOrUpdateOpensearchCluster:input_type -> loggingadmin.OpensearchClusterV2
	30, // 37: loggingadmin.LoggingAdminV2.UpgradeAvailable:input_type -> google.protobuf.Empty
	9,  // 38: loggingadmin.LoggingAdminV2.DoUpgrade:input_type -> loggingadmin.UpgradeOptions
	30, // 39: loggingadmin.LoggingAdminV2.GetStorageClasses:input_type -> google.protobuf.Empty
	30, // 40: loggingadmin.LoggingAdminV2.GetOpensearchStatus:input_type -> google.protobuf.Empty
	17, // 41: loggingadmin.LoggingAdminV2.CreateOrUpdateSnapshotSchedule:input_type -> loggingadmin.SnapshotSchedule
	18, // 42: loggingadmin.LoggingAdminV2.GetSnapshotSchedule:input_type -> loggingadmin.SnapshotReference
	18, // 43: loggingadmin.LoggingAdminV2.DeleteSnapshotSchedule:input_type -> loggingadmin.SnapshotReference
	30, // 44: loggingadmin.LoggingAdminV2.ListSnapshotSchedules:input_type -> google.protobuf.Empty
	0,  // 45: loggingadmin.LoggingAdminV2.GetOpensearchCluster:output_type -> loggingadmin.OpensearchClusterV2
	30, // 46: loggingadmin.LoggingAdminV2.DeleteOpensearchCluster:output_type -> google.protobuf.Empty
	30, // 47: loggingadmin.LoggingAdminV2.CreateOrUpdateOpensearchCluster:output_type -> google.protobuf.Empty
	8,  // 48: loggingadmin.LoggingAdminV2.UpgradeAvailable:output_type -> loggingadmin.UpgradeAvailableResponse
	30, // 49: loggingadmin.LoggingAdminV2.DoUpgrade:output_type -> google.protobuf.Empty
	10, // 50: loggingadmin.LoggingAdminV2.GetStorageClasses:output_type -> loggingadmin.StorageClassResponse
	13, // 51: loggingadmin.LoggingAdminV2.GetOpensearchStatus:output_type -> loggingadmin.StatusResponse
	30, // 52: loggingadmin.LoggingAdminV2.CreateOrUpdateSnapshotSchedule:output_type -> google.protobuf.Empty
	17, // 53: loggingadmin.LoggingAdminV2.GetSnapshotSchedule:output_type -> loggingadmin.SnapshotSchedule
	30, // 54: loggingadmin.LoggingAdminV2.DeleteSnapshotSchedule:output_type -> google.protobuf.Empty
	20, // 55: loggingadmin.LoggingAdminV2.ListSnapshotSchedules:output_type -> loggingadmin.SnapshotStatusList
