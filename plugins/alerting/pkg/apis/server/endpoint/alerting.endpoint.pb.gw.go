...
func request_AlertEndpoints_EphemeralDispatcher_0(ctx context.Context, marshaler runtime.Marshaler, client AlertEndpointsClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq v1_0.EphemeralDispatcherRequest
	var metadata runtime.ServerMetadata
...
func RegisterAlertEndpointsHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AlertEndpointsServer) error {
	...
	mux.Handle("POST", pattern_AlertEndpoints_EphemeralDispatcher_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/alerting.endpoint.AlertEndpoints/EphemeralDispatcher", runtime.WithHTTPPathPattern("/ephemeral"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterAlertEndpointsHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AlertEndpointsClient) error {
	...
	mux.Handle("POST", pattern_AlertEndpoints_EphemeralDispatcher_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/alerting.endpoint.AlertEndpoints/EphemeralDispatcher", runtime.WithHTTPPathPattern("/ephemeral"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
