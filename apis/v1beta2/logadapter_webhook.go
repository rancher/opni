...
//+kubebuilder:webhook:path=/mutate-opni-io-v1beta2-logadapter,mutating=true,failurePolicy=fail,sideEffects=None,groups=opni.io,resources=logadapters,verbs=create;update,versions=v1beta2,name=mlogadapter2.kb.io,admissionReviewVersions={v1,v1beta1}
...
//+kubebuilder:webhook:path=/validate-opni-io-v1beta2-logadapter,mutating=false,failurePolicy=fail,sideEffects=None,groups=opni.io,resources=logadapters,verbs=create;update,versions=v1beta2,name=vlogadapter2.kb.io,admissionReviewVersions={v1,v1beta1}
