...
replace (
	...
	github.com/cortexproject/cortex => github.com/kralicky/cortex v1.16.0-opni.2
...
// Version pins
replace github.com/thanos-io/thanos => github.com/thanos-io/thanos v0.31.1-0.20230717161853-6fda58a6291f
