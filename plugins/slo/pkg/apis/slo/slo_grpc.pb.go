...
func (c *sLOClient) GetMetric(ctx context.Context, in *MetricRequest, opts ...grpc.CallOption) (*Metric, error) {
	out := new(Metric)
...
func (UnimplementedSLOServer) GetMetric(context.Context, *MetricRequest) (*Metric, error) {
...
func _SLO_GetMetric_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(SLOServer).GetMetric(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/slo.SLO/GetMetric",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SLOServer).GetMetric(ctx, req.(*MetricRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SLO_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "plugins/slo/pkg/apis/slo/slo.proto",
}
