...
func (in *Config) FlagSet(prefix ...string) *pflag.FlagSet {
	...
	fs.BoolVar(&in.ThanosEngine, strings.Join(append(prefix, "thanos-engine"), "."), false, "Experimental. Use Thanos promql engine https://github.com/thanos-community/promql-engine rather than the Prometheus promql engine.")
	return fs
}
