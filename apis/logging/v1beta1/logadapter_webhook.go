...
//+kubebuilder:webhook:path=/mutate-logging-opni-io-v1beta1-logadapter,mutating=true,failurePolicy=fail,sideEffects=None,groups=logging.opni.io,resources=logadapters,verbs=create;update,versions=v1beta1,name=mlogadapter.kb.io,admissionReviewVersions={v1,v1beta1}
...
//+kubebuilder:webhook:path=/validate-logging-opni-io-v1beta1-logadapter,mutating=false,failurePolicy=fail,sideEffects=None,groups=logging.opni.io,resources=logadapters,verbs=create;update,versions=v1beta1,name=vlogadapter.kb.io,admissionReviewVersions={v1,v1beta1}
