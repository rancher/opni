...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KubeAuditSpec) DeepCopyInto(out *KubeAuditSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KubeAuditSpec.
func (in *KubeAuditSpec) DeepCopy() *KubeAuditSpec {
	if in == nil {
		return nil
	}
	out := new(KubeAuditSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *LogAdapterSpec) DeepCopyInto(out *LogAdapterSpec) {
	*out = *in
	...
	if in.KubeAudit != nil {
		in, out := &in.KubeAudit, &out.KubeAudit
		*out = new(KubeAuditSpec)
		**out = **in
	}
	if in.Fluentbit != nil {
...
func (in *ServicesSpec) DeepCopyInto(out *ServicesSpec) {
	*out = *in
	...
	out.Preprocessing = in.Preprocessing
...
func (in *TrainingControllerSpec) DeepCopy() *TrainingControllerSpec {
	...
	out := new(TrainingControllerSpec)
	in.DeepCopyInto(out)
	return out
}
