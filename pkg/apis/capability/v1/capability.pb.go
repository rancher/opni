...
var file_github_com_rancher_opni_pkg_apis_capability_v1_capability_proto_depIdxs = []int32{
	...
	1,  // 16: capability.Backend.Info:output_type -> capability.Details
	12, // 17: capability.Backend.CanInstall:output_type -> google.protobuf.Empty
	5,  // 18: capability.Backend.Install:output_type -> capability.InstallResponse
	8,  // 19: capability.Backend.Status:output_type -> capability.NodeCapabilityStatus
	12, // 20: capability.Backend.Uninstall:output_type -> google.protobuf.Empty
	13, // 21: capability.Backend.UninstallStatus:output_type -> core.TaskStatus
	12, // 22: capability.Backend.CancelUninstall:output_type -> google.protobuf.Empty
	7,  // 23: capability.Backend.InstallerTemplate:output_type -> capability.InstallerTemplateResponse
	12, // 24: capability.Node.SyncNow:output_type -> google.protobuf.Empty
