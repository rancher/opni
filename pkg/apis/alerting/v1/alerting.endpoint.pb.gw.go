...
func request_AlertEndpoints_ToggleDefault_0(ctx context.Context, marshaler runtime.Marshaler, client AlertEndpointsClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ToggleDefaultRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.ToggleDefault(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_AlertEndpoints_ToggleDefault_0(ctx context.Context, marshaler runtime.Marshaler, server AlertEndpointsServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ToggleDefaultRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ToggleDefault(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterAlertEndpointsHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AlertEndpointsServer) error {
	...
	mux.Handle("POST", pattern_AlertEndpoints_ToggleDefault_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/alerting.AlertEndpoints/ToggleDefault", runtime.WithHTTPPathPattern("/toggleDefault"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_AlertEndpoints_ToggleDefault_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_AlertEndpoints_ToggleDefault_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterAlertEndpointsHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AlertEndpointsClient) error {
	...
	mux.Handle("POST", pattern_AlertEndpoints_ToggleDefault_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/alerting.AlertEndpoints/ToggleDefault", runtime.WithHTTPPathPattern("/toggleDefault"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_AlertEndpoints_ToggleDefault_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_AlertEndpoints_ToggleDefault_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"toggleDefault"}, ""))
...
var (
	...
	forward_AlertEndpoints_ToggleDefault_0 = runtime.ForwardResponseMessage
